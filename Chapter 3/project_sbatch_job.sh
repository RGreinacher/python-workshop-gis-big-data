...
#SBATCH -e /n/home01/rspang/results/job_errout_%j.err  # File to which STDERR will be written, %j inserts jobid
...
# run code
python precipitation_sentiment_toy_example_chap3.py
